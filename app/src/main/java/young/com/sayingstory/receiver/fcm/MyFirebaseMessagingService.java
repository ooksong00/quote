...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        String quoteText = data.get("quote_text").toString();

        Quote quote = new Quote();
        quote.setId(Integer.parseInt(id));
        quote.setAuthor(author);
        quote.setQuoteText(quoteText);
        quote.setCreatedAt("Today");
        quote.setIsEnterByPush(true);
        String message = quoteText + "―" + author;

        sendNotification(message, quote);
     ...
     */
    private void sendNotification(String messageBody, Quote quote) {
        Log.d(TAG, "sendNotification" + messageBody);
        Intent intent = new Intent(this, DetailedQuoteActivity.class);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                ...
                .setContentTitle("Today's Saying")
