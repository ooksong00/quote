package young.com.sayingstory.ui.setting.login;
...
public class LoginDialogActivity extends BaseActivity implements
    ...
    private void updateUI(FirebaseUser user) {
        hideProgressDialog();
        if (user != null) {
            StringTokenizer tokens = new StringTokenizer(user.getEmail());
            String userId = tokens.nextToken("@");
            SharedPreferencesManager.setStringValue(getApplicationContext(), SharedPreferenceConst.USER_NAME, userId);
            googleSignInButton.setVisibility(View.GONE);
            signOutButton.setVisibility(View.VISIBLE);
            SharedPreferencesManager.setStringValue(this, SharedPreferenceConst.USER_NAME, userId);
            EventBus.getDefault().post(new LoginEvent("Hello, " + userId));

        } else {
            SharedPreferencesManager.removeStringValue(getApplicationContext(), SharedPreferenceConst.USER_NAME);
